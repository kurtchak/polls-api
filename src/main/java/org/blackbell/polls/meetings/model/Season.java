...
public class Season {
    ...
    private long id;
    @JsonView(value = {Views.Seasons.class, Views.Poll.class, Views.CouncilMember.class, Views.Towns.class, Views.Clubs.class})
    private String ref;

    @JsonView(value = {Views.Seasons.class, Views.Towns.class, Views.Clubs.class})
    private String name;
