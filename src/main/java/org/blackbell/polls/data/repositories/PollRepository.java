...
public interface PollRepository extends JpaRepository<Poll, Long> {
    @Query(value = "select p from Poll p where p.agendaItem.meeting.season.town.name = :town and p.agendaItem.meeting.season.institution = :institution and p.agendaItem.meeting.season.name = :season")
